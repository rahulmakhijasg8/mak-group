const CompaniesSection = () => {
  ...
  return (
    <section className="w-full mx-auto max-w-7xl mt-[60px] md:mt-[100px] py-[32px] py-[60px] md:py-16 px-4 md:px-[60px] lg:px-[80px] bg-gradient-to-br from-[#FAFAFA] to-[#F5F5F5]">
